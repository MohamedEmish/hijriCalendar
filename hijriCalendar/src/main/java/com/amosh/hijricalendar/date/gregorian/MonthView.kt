...
abstract class MonthView @JvmOverloads constructor(
    ...
    inner class MonthViewTouchHelper(host: View) : ExploreByTouchHelper(host) {
        ...
        private val mTempCalendar = Calendar.getInstance(mController.timeZone)
        ...
        private fun getItemDescription(day: Int): CharSequence {
            ...
            val date = DateFormat.format(DATE_FORMAT,
    ...
    companion object {
        ...
        private var MONTH_HEADER_SIZE = 0
         ...
         * A wrapper to the MonthHeaderSize to allow override it in children
         */
        var monthHeaderSize: Int = MONTH_HEADER_SIZE
    ...
    init {
        ...
        mDayLabelCalendar = Calendar.getInstance(mController.timeZone, mController.locale)
        mCalendar = Calendar.getInstance(mController.timeZone, mController.locale)
