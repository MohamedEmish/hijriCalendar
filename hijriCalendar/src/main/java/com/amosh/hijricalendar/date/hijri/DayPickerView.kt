 ...
 */
abstract class DayPickerView : ListView, AbsListView.OnScrollListener, HijriDatePickerDialog.OnDateChangedListener {
    ...
    private fun setController(controller: DatePickerController) {
        ...
        YEAR_FORMAT = SimpleDateFormat("yyyy", mController.locale)
        refreshAdapter()
        onDateChanged()
    }
    ...
    private fun goTo(day: MonthAdapter.CalendarDay?, animate: Boolean, setSelected: Boolean): Boolean {
        ...
        mTempDay!!.set(day)
        val minMonth = mController.startDate.get(UmmalquraCalendar.MONTH)
    ...
    override fun performAccessibilityAction(action: Int, arguments: Bundle): Boolean {
        ...
        val minMonth: Int = mController.startDate.get(UmmalquraCalendar.MONTH)
