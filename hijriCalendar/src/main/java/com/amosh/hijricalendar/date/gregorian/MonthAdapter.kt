...
abstract class MonthAdapter(
    ...
    override fun getCount(): Int {
        ...
        val endMonth = endDate[Calendar.YEAR] * MONTHS_IN_YEAR + endDate[Calendar.MONTH]
        val startMonth = startDate[Calendar.YEAR] * MONTHS_IN_YEAR + startDate[Calendar.MONTH]
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        drawingParams.clear()
        val month = (position + mController.startDate[Calendar.MONTH]) % MONTHS_IN_YEAR
        val year = (position + mController.startDate[Calendar.MONTH]) / MONTHS_IN_YEAR + mController.minYear
        var selectedDay = -1
